...
<nav class="navbar navbar-expand-sm bg-light">
    <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#" style="color: #1f6f4a">评价订单</a>
        </li>
        <li class="nav-item">
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${orders}" var="order" varStatus="stat">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/userCommentPage?order_id=${order.id}"
                               class="text-primary">评价</a></td>
                        </c:when>
                        <c:otherwise>
                            <td>已评价</td>
                        </c:otherwise>
                ...
                <tr valign="top">
                    <td align="center" colspan="12" rowspan="2">
                        <fkjava:pager
                                ...
                                submitUrl="${pageContext.request.contextPath}/commentOrder?pageIndex={0}"/>
                    </td>
                </tr>
                </tbody>
            </table>
